                                ...
                                <ul id="comments-list" class="comments-list">
                                    <li>
                                        <div class="comment-main-level">
                                            <!-- Avatar -->
                                            <div class="comment-avatar"> <img src="assets/img/comment-1.jpg" alt="comment"> </div>
                                        ...
                                        <ul class="comments-list reply-list">
                                            <li>
                                                <!-- Avatar -->
                                                <div class="comment-avatar"> <img src="assets/img/comment-2.jpg" alt="comment"> </div>
                                                <!-- Contenedor del Comentario -->
                                                <div class="comment-box">
                                                    <div class="comment-head">
                                            ...
                                            <li>
                                                <!-- Avatar -->
                                                <div class="comment-avatar"> <img src="assets/img/comment-3.jpg" alt="comment"> </div>
                                                <!-- Contenedor del Comentario -->
                                                <div class="comment-box">
                                                    <div class="comment-head">
                                                        <h6 class="comment-name by-author"><a href="http://creaticode.com/blog">Agustin Ortiz</a></h6>
                                    ...
                                    <li>
                                        <div class="comment-main-level">
                                            <!-- Avatar -->
                                            <div class="comment-avatar"> <img src="assets/img/comment-4.jpg" alt="comment"> </div>
                                            <!-- Contenedor del Comentario -->
                                            <div class="comment-box">
                                                <div class="comment-head">
                                                    <h6 class="comment-name"><a href="http://creaticode.com/blog">Lorena Rojero</a></h6>
                        ...
                        <div class="sidebar-wrap">
                            ...
                            <div class="sidebar-widget mb-50">
                                ...
                                <ul class="recent-posts">
                                    <li>
                                        <img src="assets/img/rel-post-1.jpg" alt="blog post">
                                        <div>
                                    ...
                                    <li>
                                        <img src="assets/img/rel-post-2.jpg" alt="blog post">
                                        <div>
                                    ...
                                    <li>
                                        <img src="assets/img/rel-post-3.jpg" alt="blog post">
                                        <div>
                                    ...
                                    <li>
                                        <img src="assets/img/rel-post-4.jpg" alt="blog post">
                                        <div>
                                    ...
                                    <li>
                                        <img src="assets/img/rel-post-5.jpg" alt="blog post">
                                        <div>
