                   ...
                   <div class="col-lg-3 xs-padding">
                    ...
                    <div class="col-md-9 xs-padding">
                        <div class="blog-items row">
                            ...
                            <div class="col-md-6 padding-15">
                                <div class="blog-post">
                                    <img src="assets/img/post-2.jpg" alt="blog post">
                                    <div class="blog-content">
                                        <span class="date"><i class="fa fa-clock-o"></i> January 01.2018</span>
                            ...
                            <div class="col-md-6 padding-15">
                                <div class="blog-post">
                                    <img src="assets/img/post-3.jpg" alt="blog post">
                                    <div class="blog-content">
                                        <span class="date"><i class="fa fa-clock-o"></i> January 01.2018</span>
                                        <h3><a href="#">Standard gallery post</a></h3>
                                        <p>The secret to happiness lies in helping others. Never underestimate the difference</p>
                            ...
                            <div class="col-md-6 padding-15">
                                <div class="blog-post">
                                    <img src="assets/img/post-4.jpg" alt="blog post">
                                    <div class="blog-content">
                                        <span class="date"><i class="fa fa-clock-o"></i> January 01.2018</span>
                                        <h3><a href="#">Blog post with couple photos</a></h3>
                                        <p>The secret to happiness lies in helping others. Never underestimate the difference</p>
                            ...
                            <div class="col-md-6 padding-15">
                                <div class="blog-post">
                                    <img src="assets/img/post-5.jpg" alt="blog post">
                                    <div class="blog-content">
                                        <span class="date"><i class="fa fa-clock-o"></i> January 01.2018</span>
                                        <h3><a href="#">Standard gallery post</a></h3>
                                        <p>The secret to happiness lies in helping others. Never underestimate the difference</p>
                            ...
                            <div class="col-md-6 padding-15">
                                <div class="blog-post">
                                    <img src="assets/img/post-6.jpg" alt="blog post">
                                    <div class="blog-content">
                                        <span class="date"><i class="fa fa-clock-o"></i> January 01.2018</span>
                                        <h3><a href="#">Blog post with couple photos</a></h3>
                                        <p>The secret to happiness lies in helping others. Never underestimate the difference</p>
